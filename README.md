...
3. **Генерация изображений** — 3 варианта изображений товара в разных сценах (image-to-image через Replicate)
...
Основное фото товара → 3 варианта в разных сценах (студия, кухня и т.п.).
...
- `POST /content/images/{product_id}` — генерация 3 изображений (async, BackgroundTasks)
...
- **Изображения:** 3 варианта через image-to-image — товар в разных сценах
